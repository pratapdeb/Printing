...
import { PVCPreview } from './PVCPreview';
...
interface PVCPreviewPanelProps {
    imageUrl: string | null;
    selection: Selection | null;
    onPrint: () => void;
}

export const PVCPreviewPanel: React.FC<PVCPreviewPanelProps> = ({
    imageUrl,
    selection,
    onPrint,
}) => {
    return (
        <div className="flex flex-col gap-6 h-full overflow-y-auto p-4 bg-gray-50">
            ...
            <div className="grid grid-cols-1 gap-8 max-w-sm mx-auto w-full">
                <PVCPreview
                    title="PVC Preview"
                    imageUrl={imageUrl}
                    selection={selection}
